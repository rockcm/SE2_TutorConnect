...
# Changed the name and email fields in Tutor model to be a FK to User
# table. This ensures all tutors are users.
...
class User(Base):
    ...
    preferred_subjects = Column(ARRAY(Integer),
                                nullable=True)  # References Subject IDs
...
class Tutor(Base):
    ...
    # Replaced duplicate email and name fields with a foreign key reference to
    # the User table
    user_id = Column(
        Integer,
